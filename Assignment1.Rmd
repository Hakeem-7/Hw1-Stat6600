...
$\mathbf{Note:}$ The sample percentage using the proportion of a standard normal distribution.
...
Interval: $\bar{x}\pm t_\frac{\alpha}{2},_{n-2} *\frac{S_n}{\sqrt{n}}$ = $16.706 \pm 0.0747$ 
